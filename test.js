;(function (window, document, undefined) {
  ...
  /**
   * 根据事件对象获取修饰按键数组，ctrl shift alt meta
   * @param {Event} e
   * @returns {Array}
   */
  ...
  function _getKeyInfo(combination, action) {
    ...
    // console.log('combination', combination, keys)
  ...
  function Mousetrap(targetElement) {
    ...
    self._handleKey = function (character, modifiers, e) {
      console.log(2, character, modifiers, e, self._callbacks)
      ...
      console.log(1111, callbacks.length, e)
    ...
    function _bindSingle(combination, callback, action, sequenceName, level) {
      ...
      console.log('_getKeyInfo', combination)
  ...
  /**
   * 绑定组合键
   * @param {string|Array} keys 按键
   * @param {Function} callback 回调
   * @param {string=} action - 事件类型：'keypress', 'keydown', or 'keyup'
   * @returns void
   */
